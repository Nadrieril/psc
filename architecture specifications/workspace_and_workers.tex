...
\begin{itemize}
 ...
 \item Ajouter de l'information ne provenant pas directement du texte, mais jugée importante ! (Ex. trivial des n\oe uds fortement activés dans le RC)
...
\begin{itemize}
 \item Une relation (sujet-objet, objet-caractéristique), cf concepnet5
...
Priorité 1  : reconstruire l'information de la phrase à l'intérieur du workspace, avec le moins de perte possibles

Priorité 2 : élaguer le workspace pour garder l'info pertinente et non-redondante.

Priorité 3 : faire les deux en même temps parce que ça s'y prête bien
...
Classe-mère. Augmente le temps lors du lancement du worker.
...
\begin{itemize}
 ...
 \item Il cherche les instances des prédécesseurs activés et construit des liens pour chacune d'entre elles
 \item Il push un LinkBuilder qui va chercher de l'information supplémentaire du textspace
\end{itemize}
...
\begin{itemize}
 ...
 \end{itemize}
  ...
  \begin{itemize}
   ...
   \item Créer un lien avec cette instance
...
\begin{enumerate}
 ...
 \item Un worker initial est appelé sur l'arbre sémantique ;
 ...
 \item Étant donné un n\oe ud qui vient d'être instancié, on crée un worker chargé de trouver des liens partant de ce n\oe ud.

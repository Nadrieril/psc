...
class Node :
    ...
    def addLink(self, lien, de):
        ...
        if(de in self.linksOut):
            del self.linksOut[de]#il faut écraser le précédent : à tout instant, il n'y a qu'un seul lien venant d'un noeud donné
    ...
    def describeLinks(self):
        ...
        for l, n in self.linksOut.iteritems() :
...
class NodeObserver:
    ...
    def draw(self):#trace un graphe mignon de l'activation en fonction du temps
        print(self.times)

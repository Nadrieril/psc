...
def expand_names(network,words,sl_writer,bl_writer):
	"""
...
def expand_edges(network,words,sl_writer,bl_writer):
	"""
	Warning : words is a dict
	"""
	#1 : expand with traditional links
...
def use_method_on_network(network,expand_method,max):
	"""
	param expand_method : the method to use
...
def perform_operation(op,nodes_file,edges_file,result,limit=1000):
	...
	print("working...")
	use_method_on_network(n,op,limit)
	print("saving...")
...
perform_operation(expand_similarity,
	"wayne2/wayne2_nodes.jsons","wayne2/wayne2_edges.jsons","wayne3",limit=100000)

#perform_operation(expand_to_existing_nodes,
#	"wayne2/wayne3_nodes.jsons","wayne2/wayne3_edges.jsons","wayne4",limit=100000)


#perform_operation(tag_linked_nodes,
#	"wayne2/wayne4_nodes.jsons","wayne2/wayne4_edges.jsons","wayne4",limit=100000)



#perform_operation(clear_nodes,
#	"wayne2/wayne4_nodes.jsons","wayne2/wayne4_edges.jsons","wayne5",limit=100000)

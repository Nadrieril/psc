...
Nous cherchons à mettre sur pied un synthétiseur automatiques de documents rédigés en langue anglaise, c'est à dire un programme capable de créer de résumer un ou plusieurs documents écrits dans cette langue.
...
L'utilisation de la langue anglaise nous permet d'envisager d'utiliser des analyseurs syntaxiques \emph{open-source}. Notre tuteur, de l'entreprise française systran, nous a également proposé d'utiliser certains de ses outils.
...
\begin{itemize}
  ...
  \item Faire intervenir des données supplémentaires sous la forme d'un réseau de concepts, représentant en première approximation le bon sens et qui influence la lecture du texte et l'importance relative des idées perçues.
\end{itemize}

""" Ce program permet de chercher les mots-clé pour tous les documents
    dans un corpus et aussi créer une liste de stop-words.
    Mais j'ai aussi trouver un package python 
    scikit-learn http://scikit-learn.org/stable/install.html
    qui permet de calculer la matrice de l'indice TF-IDF
